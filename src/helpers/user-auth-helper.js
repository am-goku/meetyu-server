...
const loginAndRegister = {
  ...
  // @access Public
  register_helper: ({ name, username, email, pass, confPass }) => {
    return new Promise(async (resolve, reject) => {
      try {
        if (pass !== confPass)
          return reject({
...
export const {
  ...
  auth_helper,
  tokenRefresh_helper,
} = { ...loginAndRegister, ...authentication, ...tokenRel };
